...
store.dispatch({ type: "account/requestLoan", payload: {amount: 100000, purpose: 'Buy a Car'} });
console.log(store.getState());
...
store.dispatch(createCustomer("Alaa Hamdy", "10"))
console.log(store.getState());

store.dispatch(updateName("Alaa Hamdy Mohammadi"));
console.log(store.getState());